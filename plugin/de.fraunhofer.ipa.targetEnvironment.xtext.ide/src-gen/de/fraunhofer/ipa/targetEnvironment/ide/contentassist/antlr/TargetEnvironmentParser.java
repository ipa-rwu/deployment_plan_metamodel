...
public class TargetEnvironmentParser extends AbstractContentAssistParser {
  ...
  public static final class NameMappings {
    ...
    private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TargetEnvironmentGrammarAccess grammarAccess) {
      ...
      builder.put(grammarAccess.getAbstractDeviceInstanceAccess().getAlternatives(), "rule__AbstractDeviceInstance__Alternatives");
      ...
      builder.put(grammarAccess.getDeviceInstanceAccess().getGroup_6(), "rule__DeviceInstance__Group_6__0");
      builder.put(grammarAccess.getComputationDeviceInstanceAccess().getGroup(), "rule__ComputationDeviceInstance__Group__0");
      builder.put(grammarAccess.getComputationDeviceInstanceAccess().getGroup_6(), "rule__ComputationDeviceInstance__Group_6__0");
      ...
      builder.put(grammarAccess.getConfigConnectionPropertyAccess().getGroup_7(), "rule__ConfigConnectionProperty__Group_7__0");
      builder.put(grammarAccess.getConfigDevicePropertyAccess().getGroup(), "rule__ConfigDeviceProperty__Group__0");
      ...
      builder.put(grammarAccess.getComputationDeviceTypeAccess().getGroup_5_4(), "rule__ComputationDeviceType__Group_5_4__0");
      ...
      builder.put(grammarAccess.getProcessorResouceAccess().getGroup_6(), "rule__ProcessorResouce__Group_6__0");
      ...
      builder.put(grammarAccess.getTargetDeployEnviromentAccess().getIncludeDeviceAssignment_5_4(), "rule__TargetDeployEnviroment__IncludeDeviceAssignment_5_4");
      builder.put(grammarAccess.getTargetDeployEnviromentAccess().getIncludeDeviceAssignment_5_8(), "rule__TargetDeployEnviroment__IncludeDeviceAssignment_5_8");
      builder.put(grammarAccess.getTargetDeployEnviromentAccess().getConfigConnectionsAssignment_6_2(), "rule__TargetDeployEnviroment__ConfigConnectionsAssignment_6_2");
      ...
      builder.put(grammarAccess.getDeviceInstanceAccess().getConfigDevicePropertyAssignment_6_2(), "rule__DeviceInstance__ConfigDevicePropertyAssignment_6_2");
      builder.put(grammarAccess.getComputationDeviceInstanceAccess().getNameAssignment_2(), "rule__ComputationDeviceInstance__NameAssignment_2");
      builder.put(grammarAccess.getComputationDeviceInstanceAccess().getRefDeviceTypeAssignment_5(), "rule__ComputationDeviceInstance__RefDeviceTypeAssignment_5");
      builder.put(grammarAccess.getComputationDeviceInstanceAccess().getConfigDevicePropertyAssignment_6_2(), "rule__ComputationDeviceInstance__ConfigDevicePropertyAssignment_6_2");
      ...
      builder.put(grammarAccess.getConfigConnectionPropertyAccess().getNameAssignment_3(), "rule__ConfigConnectionProperty__NameAssignment_3");
      ...
      builder.put(grammarAccess.getComputationDeviceTypeAccess().getComputationResourceAssignment_5_3(), "rule__ComputationDeviceType__ComputationResourceAssignment_5_3");
      builder.put(grammarAccess.getComputationDeviceTypeAccess().getComputationResourceAssignment_5_4_1(), "rule__ComputationDeviceType__ComputationResourceAssignment_5_4_1");
      ...
      builder.put(grammarAccess.getProcessorResouceAccess().getNameAssignment_2(), "rule__ProcessorResouce__NameAssignment_2");
      builder.put(grammarAccess.getProcessorResouceAccess().getTypeAssignment_5(), "rule__ProcessorResouce__TypeAssignment_5");
      builder.put(grammarAccess.getProcessorResouceAccess().getPropertiesAssignment_6_2(), "rule__ProcessorResouce__PropertiesAssignment_6_2");

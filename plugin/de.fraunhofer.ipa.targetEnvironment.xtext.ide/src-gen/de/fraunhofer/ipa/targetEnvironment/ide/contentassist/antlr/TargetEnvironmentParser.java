...
public class TargetEnvironmentParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TargetEnvironmentGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInterfaceNetworkPropertyAccess().getGroup_4(), "rule__InterfaceNetworkProperty__Group_4__0");
			builder.put(grammarAccess.getAddressNetworkPropertyAccess().getGroup(), "rule__AddressNetworkProperty__Group__0");
			builder.put(grammarAccess.getAddressNetworkPropertyAccess().getGroup_4(), "rule__AddressNetworkProperty__Group_4__0");
			...
			builder.put(grammarAccess.getInterfaceNetworkPropertyAccess().getValueAssignment_4_2(), "rule__InterfaceNetworkProperty__ValueAssignment_4_2");
			builder.put(grammarAccess.getAddressNetworkPropertyAccess().getValueAssignment_4_2(), "rule__AddressNetworkProperty__ValueAssignment_4_2");
			...
			builder.put(grammarAccess.getComputationDeviceTypeAccess().getCapabilityAssignment_4_2(), "rule__ComputationDeviceType__CapabilityAssignment_4_2");
			...
			builder.put(grammarAccess.getCapabilityPropertyAccess().getTypeAssignment_7(), "rule__CapabilityProperty__TypeAssignment_7");

 ...
 * </p>
 * <ul>
 *   <li>{@link de.fraunhofer.ipa.deployment.util.impl.PropertyImpl#getName <em>Name</em>}</li>
...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	public NotificationChain basicSetValue(PropertyValue newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UtilPackage.PROPERTY__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UtilPackage.PROPERTY__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UtilPackage.PROPERTY__VALUE, newValue, newValue));
	}

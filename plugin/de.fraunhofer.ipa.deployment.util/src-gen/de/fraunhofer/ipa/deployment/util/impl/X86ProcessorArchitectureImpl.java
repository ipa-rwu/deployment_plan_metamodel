 ...
 * </p>
 * <ul>
 *   <li>{@link de.fraunhofer.ipa.deployment.util.impl.X86ProcessorArchitectureImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class X86ProcessorArchitectureImpl extends ProcessorArchitectureImpl implements X86ProcessorArchitecture {
	/**
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "x86";
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UtilPackage.X86_PROCESSOR_ARCHITECTURE__NAME:
			return getName();
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link de.fraunhofer.ipa.deployment.util.impl.PropertyValueDoubleImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyValueDoubleImpl extends PropertyValueImpl implements PropertyValueDouble {
    ...
    protected EClass eStaticClass() {
        return UtilPackage.Literals.PROPERTY_VALUE_DOUBLE;
    }
    ...
    public void setValue(double newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UtilPackage.PROPERTY_VALUE_DOUBLE__VALUE, oldValue,
                    value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case UtilPackage.PROPERTY_VALUE_DOUBLE__VALUE:
            return getValue();
        }

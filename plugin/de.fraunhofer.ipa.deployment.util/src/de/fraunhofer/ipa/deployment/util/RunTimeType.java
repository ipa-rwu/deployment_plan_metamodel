...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Run Time Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.fraunhofer.ipa.deployment.util.UtilPackage#getRunTimeType()
 * @model
 * @generated
 */
public enum RunTimeType implements Enumerator {
    ...
    /**
     * An array of all the '<em><b>Run Time Type</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final RunTimeType[] VALUES_ARRAY = new RunTimeType[] { CONTAINER, };

    /**
     * A public read-only list of all the '<em><b>Run Time Type</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    /**
     * Returns the '<em><b>Run Time Type</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Returns the '<em><b>Run Time Type</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
    ...
    /**
     * Returns the '<em><b>Run Time Type</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->

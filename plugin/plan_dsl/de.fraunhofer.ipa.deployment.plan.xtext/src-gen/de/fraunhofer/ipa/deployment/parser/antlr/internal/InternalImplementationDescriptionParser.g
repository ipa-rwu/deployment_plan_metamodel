...
// Entry rule entryRuleImplementationDescriptionSet
entryRuleImplementationDescriptionSet returns [EObject current=null]:
  ...
  { $current=$iv_ruleImplementationDescriptionSet.current; }
  EOF;

// Rule ImplementationDescriptionSet
ruleImplementationDescriptionSet returns [EObject current=null]
@init {
  enterRule();
}
@after {
...
@after {
  ...
  (
    ...
    (
      otherlv_9=ExecutionRequirement
      {
...
// Entry rule entryRuleRepositoryType
entryRuleRepositoryType returns [EObject current=null]:
  { newCompositeNode(grammarAccess.getRepositoryTypeRule()); }
  iv_ruleRepositoryType=ruleRepositoryType
  { $current=$iv_ruleRepositoryType.current; }
  EOF;

// Rule RepositoryType
ruleRepositoryType returns [EObject current=null]
@init {
  enterRule();
}
@after {
  ...
  {
    $current = $this_GitRepositoryType_0.current;
    afterParserOrEnumRuleCall();
  }
;

// Entry rule entryRuleGitRepositoryType
entryRuleGitRepositoryType returns [EObject current=null]:
  { newCompositeNode(grammarAccess.getGitRepositoryTypeRule()); }
  iv_ruleGitRepositoryType=ruleGitRepositoryType
  { $current=$iv_ruleGitRepositoryType.current; }
  EOF;

// Rule GitRepositoryType
ruleGitRepositoryType returns [EObject current=null]
@init {
  enterRule();
}
@after {

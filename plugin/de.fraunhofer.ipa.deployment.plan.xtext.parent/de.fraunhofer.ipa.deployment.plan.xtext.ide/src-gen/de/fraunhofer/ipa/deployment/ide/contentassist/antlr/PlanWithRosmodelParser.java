...
public class PlanWithRosmodelParser extends AbstractContentAssistParser {
    ...
    public static final class NameMappings {
        ...
        private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PlanWithRosmodelGrammarAccess grammarAccess) {
            ...
            builder.put(grammarAccess.getRossystemImplementationAssignmentAccess().getGroup_12(), "rule__RossystemImplementationAssignment__Group_12__0");
            ...
            builder.put(grammarAccess.getRossystemImplementationAssignmentAccess().getGroup_15(), "rule__RossystemImplementationAssignment__Group_15__0");
            ...
            builder.put(grammarAccess.getConfigRosParameterAccess().getGroup_3_1(), "rule__ConfigRosParameter__Group_3_1__0");
            builder.put(grammarAccess.getConfigRosParameterAccess().getGroup_3_2(), "rule__ConfigRosParameter__Group_3_2__0");
            ...
            builder.put(grammarAccess.getRossystemImplementationAssignmentAccess().getSoftwareComponentsAssignment_11(), "rule__RossystemImplementationAssignment__SoftwareComponentsAssignment_11");
            builder.put(grammarAccess.getRossystemImplementationAssignmentAccess().getSoftwareComponentsAssignment_12_1(), "rule__RossystemImplementationAssignment__SoftwareComponentsAssignment_12_1");
            builder.put(grammarAccess.getRossystemImplementationAssignmentAccess().getMiddlewareAssignment_14_1(), "rule__RossystemImplementationAssignment__MiddlewareAssignment_14_1");
            builder.put(grammarAccess.getRossystemImplementationAssignmentAccess().getRuntimeTypeAssignment_15_1(), "rule__RossystemImplementationAssignment__RuntimeTypeAssignment_15_1");
            builder.put(grammarAccess.getConfigRosParameterAccess().getFromAssignment_2(), "rule__ConfigRosParameter__FromAssignment_2");
            builder.put(grammarAccess.getConfigRosParameterAccess().getToAssignment_3_1_1(), "rule__ConfigRosParameter__ToAssignment_3_1_1");
            builder.put(grammarAccess.getConfigRosParameterAccess().getValueAssignment_3_2_1(), "rule__ConfigRosParameter__ValueAssignment_3_2_1");

...
public class DeployPlanWithRosModelAdapterFactory extends AdapterFactoryImpl {
   ...
   */
    protected DeployPlanWithRosModelSwitch<Adapter> modelSwitch =
      ...
      @Override
      public Adapter caseDeployRossystemPlan(DeployRossystemPlan object) {
        return createDeployRossystemPlanAdapter();
      }
      @Override
   ...
   */
    ...
    /**
   * Creates a new adapter for an object of class '{@link deployPlanWithRosModel.DeployRossystemPlan <em>Deploy Rossystem Plan</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDeployRossystemPlanAdapter() {
    return null;
  }

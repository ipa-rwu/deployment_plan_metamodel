...
entryRuleDeploymentPlanWithRosModel returns [EObject current=null]:
  ...
  { $current=$iv_ruleDeploymentPlanWithRosModel.current; }
  EOF;

// Rule DeploymentPlanWithRosModel
ruleDeploymentPlanWithRosModel returns [EObject current=null]
@init {
  enterRule();
}
@after {
  ...
  (
    otherlv_0=DeploymentPlanWithRos
    {
...
entryRuleConfigRosSoftwareComponent returns [EObject current=null]:
  ...
  { $current=$iv_ruleConfigRosSoftwareComponent.current; }
  EOF;

// Rule ConfigRosSoftwareComponent
ruleConfigRosSoftwareComponent returns [EObject current=null]
@init {
  enterRule();
}
@after {
  ...
  (
    ...
    (
      ...
      (
        otherlv_4=ExecutionConfiguration
        {
...
entryRuleConfigRosParameter returns [EObject current=null]:
  { newCompositeNode(grammarAccess.getConfigRosParameterRule()); }
  iv_ruleConfigRosParameter=ruleConfigRosParameter
  { $current=$iv_ruleConfigRosParameter.current; }
  EOF;

// Rule ConfigRosParameter
ruleConfigRosParameter returns [EObject current=null]
@init {
  enterRule();
}
@after {
...
entryRuleAbstractRuntime returns [EObject current=null]:
  { newCompositeNode(grammarAccess.getAbstractRuntimeRule()); }
  iv_ruleAbstractRuntime=ruleAbstractRuntime
  { $current=$iv_ruleAbstractRuntime.current; }
  EOF;

// Rule AbstractRuntime
ruleAbstractRuntime returns [EObject current=null]
@init {
  enterRule();
}
@after {
  ...
  {
    $current = $this_ContainerRuntime_0.current;
    afterParserOrEnumRuleCall();
  }
;

// Entry rule entryRuleContainerRuntime
entryRuleContainerRuntime returns [EObject current=null]:
  { newCompositeNode(grammarAccess.getContainerRuntimeRule()); }
  iv_ruleContainerRuntime=ruleContainerRuntime
  { $current=$iv_ruleContainerRuntime.current; }
  EOF;

// Rule ContainerRuntime
ruleContainerRuntime returns [EObject current=null]
@init {
  enterRule();
}
@after {

...
@Singleton
public class PlanWithRosmodelGrammarAccess
  ...
  public class DeploymentPlanWithRosModelElements extends AbstractParserRuleElementFinder {
    private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(
        getGrammar(), "de.fraunhofer.ipa.deployment.PlanWithRosmodel.DeploymentPlanWithRosModel");
    ...
    private final RuleCall cNameEStringParserRuleCall_3_0 =
        (RuleCall) cNameAssignment_3.eContents().get(0);
    private final Group cGroup_4 = (Group) cGroup.eContents().get(4);
    private final Keyword cTargetRossystemKeyword_4_0 = (Keyword) cGroup_4.eContents().get(0);
    private final Assignment cTargetRossystemAssignment_4_1 =
        (Assignment) cGroup_4.eContents().get(1);
    private final CrossReference cTargetRossystemSystemCrossReference_4_1_0 =
        (CrossReference) cTargetRossystemAssignment_4_1.eContents().get(0);
    private final RuleCall cTargetRossystemSystemEStringParserRuleCall_4_1_0_1 =
        (RuleCall) cTargetRossystemSystemCrossReference_4_1_0.eContents().get(1);
    private final Keyword cDeployToKeyword_5 = (Keyword) cGroup.eContents().get(5);
    private final Assignment cDeployToAssignment_6 = (Assignment) cGroup.eContents().get(6);
    private final CrossReference cDeployToTargetDeployEnviromentCrossReference_6_0 =
        (CrossReference) cDeployToAssignment_6.eContents().get(0);
    private final RuleCall cDeployToTargetDeployEnviromentEStringParserRuleCall_6_0_1 =
        (RuleCall) cDeployToTargetDeployEnviromentCrossReference_6_0.eContents().get(1);
    private final Assignment cRealizeAssignment_7 = (Assignment) cGroup.eContents().get(7);
    private final RuleCall cRealizeAbstractRealizationParserRuleCall_7_0 =
        (RuleCall) cRealizeAssignment_7.eContents().get(0);
    ...
    //'DeploymentPlanWithRos:'
    public Keyword getDeploymentPlanWithRosKeyword_0() {
      return cDeploymentPlanWithRosKeyword_0;
    }

    // INDENT
    public RuleCall getINDENTTerminalRuleCall_1() {
      return cINDENTTerminalRuleCall_1;
    }

    //'name:'
    public Keyword getNameKeyword_2() {
      return cNameKeyword_2;
    }
    ...
    public RuleCall getNameEStringParserRuleCall_3_0() {
      return cNameEStringParserRuleCall_3_0;
    }
    ...
    //'targetRossystem:'
    public Keyword getTargetRossystemKeyword_4_0() {
      return cTargetRossystemKeyword_4_0;
    }

    // targetRossystem = [rossystem::System|EString]
    public Assignment getTargetRossystemAssignment_4_1() {
      return cTargetRossystemAssignment_4_1;
    }

    //[rossystem::System|EString]
    public CrossReference getTargetRossystemSystemCrossReference_4_1_0() {
      return cTargetRossystemSystemCrossReference_4_1_0;
    }

    // EString
    public RuleCall getTargetRossystemSystemEStringParserRuleCall_4_1_0_1() {
      return cTargetRossystemSystemEStringParserRuleCall_4_1_0_1;
    }

    //'deployTo:'
    public Keyword getDeployToKeyword_5() {
      return cDeployToKeyword_5;
    }

    // deployTo=[targetEnvironment::TargetDeployEnviroment|EString]
    public Assignment getDeployToAssignment_6() {
      return cDeployToAssignment_6;
    }

    //[targetEnvironment::TargetDeployEnviroment|EString]
    public CrossReference getDeployToTargetDeployEnviromentCrossReference_6_0() {
      return cDeployToTargetDeployEnviromentCrossReference_6_0;
    }

    // EString
    public RuleCall getDeployToTargetDeployEnviromentEStringParserRuleCall_6_0_1() {
      return cDeployToTargetDeployEnviromentEStringParserRuleCall_6_0_1;
    }

    // realize=AbstractRealization
    public Assignment getRealizeAssignment_7() {
      return cRealizeAssignment_7;
    }

    // AbstractRealization
    public RuleCall getRealizeAbstractRealizationParserRuleCall_7_0() {
      return cRealizeAbstractRealizationParserRuleCall_7_0;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_8() {
      return cDEDENTTerminalRuleCall_8;
    }
  }
  public class AbstarctConfigSoftwareComponentElements extends AbstractParserRuleElementFinder {
    private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(),
        "de.fraunhofer.ipa.deployment.PlanWithRosmodel.AbstarctConfigSoftwareComponent");
    private final RuleCall cConfigRosSoftwareComponentParserRuleCall =
        (RuleCall) rule.eContents().get(1);
    ...
    // ConfigRosSoftwareComponent
    public RuleCall getConfigRosSoftwareComponentParserRuleCall() {
      return cConfigRosSoftwareComponentParserRuleCall;
    }
  }
  public class ConfigRosSoftwareComponentElements extends AbstractParserRuleElementFinder {
    private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(
        getGrammar(), "de.fraunhofer.ipa.deployment.PlanWithRosmodel.ConfigRosSoftwareComponent");
    private final Group cGroup = (Group) rule.eContents().get(1);
    ...
    private final CrossReference cComponentComponentCrossReference_1_0 =
        (CrossReference) cComponentAssignment_1.eContents().get(0);
    private final RuleCall cComponentComponentEStringParserRuleCall_1_0_1 =
        (RuleCall) cComponentComponentCrossReference_1_0.eContents().get(1);
    ...
    private final Keyword cExecutionConfigurationKeyword_2_2_0 =
        (Keyword) cGroup_2_2.eContents().get(0);
    private final RuleCall cINDENTTerminalRuleCall_2_2_1 = (RuleCall) cGroup_2_2.eContents().get(1);
    private final Assignment cExecutionConfigurationAssignment_2_2_2 =
        (Assignment) cGroup_2_2.eContents().get(2);
    private final RuleCall cExecutionConfigurationConfigRosParameterParserRuleCall_2_2_2_0 =
        (RuleCall) cExecutionConfigurationAssignment_2_2_2.eContents().get(0);
    ...
    private final RuleCall cPreListElementParserRuleCall_2_3_2 =
        (RuleCall) cGroup_2_3.eContents().get(2);
    private final Assignment cStartCommandAssignment_2_3_3 =
        (Assignment) cGroup_2_3.eContents().get(3);
    private final RuleCall cStartCommandEStringParserRuleCall_2_3_3_0 =
        (RuleCall) cStartCommandAssignment_2_3_3.eContents().get(0);
    private final Group cGroup_2_3_4 = (Group) cGroup_2_3.eContents().get(4);
    private final RuleCall cPreListElementParserRuleCall_2_3_4_0 =
        (RuleCall) cGroup_2_3_4.eContents().get(0);
    private final Assignment cStartCommandAssignment_2_3_4_1 =
        (Assignment) cGroup_2_3_4.eContents().get(1);
    private final RuleCall cStartCommandEStringParserRuleCall_2_3_4_1_0 =
        (RuleCall) cStartCommandAssignment_2_3_4_1.eContents().get(0);
    ...
    //{ConfigRosSoftwareComponent}
    public Action getConfigRosSoftwareComponentAction_0() {
      return cConfigRosSoftwareComponentAction_0;
    }

    // component=[rossystem::Component|EString]
    public Assignment getComponentAssignment_1() {
      return cComponentAssignment_1;
    }

    //[rossystem::Component|EString]
    public CrossReference getComponentComponentCrossReference_1_0() {
      return cComponentComponentCrossReference_1_0;
    }

    // EString
    public RuleCall getComponentComponentEStringParserRuleCall_1_0_1() {
      return cComponentComponentEStringParserRuleCall_1_0_1;
    }
    ...
    public Keyword getColonKeyword_2_0() {
      return cColonKeyword_2_0;
    }

    // INDENT
    public RuleCall getINDENTTerminalRuleCall_2_1() {
      return cINDENTTerminalRuleCall_2_1;
    }
    ...
    //'executionConfiguration:'
    public Keyword getExecutionConfigurationKeyword_2_2_0() {
      return cExecutionConfigurationKeyword_2_2_0;
    }

    // INDENT
    public RuleCall getINDENTTerminalRuleCall_2_2_1() {
      return cINDENTTerminalRuleCall_2_2_1;
    }

    //(executionConfiguration+=ConfigRosParameter)+
    public Assignment getExecutionConfigurationAssignment_2_2_2() {
      return cExecutionConfigurationAssignment_2_2_2;
    }

    // ConfigRosParameter
    public RuleCall getExecutionConfigurationConfigRosParameterParserRuleCall_2_2_2_0() {
      return cExecutionConfigurationConfigRosParameterParserRuleCall_2_2_2_0;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_2_2_3() {
      return cDEDENTTerminalRuleCall_2_2_3;
    }
    ...
    //'startCommand:'
    public Keyword getStartCommandKeyword_2_3_0() {
      return cStartCommandKeyword_2_3_0;
    }

    // INDENT
    public RuleCall getINDENTTerminalRuleCall_2_3_1() {
      return cINDENTTerminalRuleCall_2_3_1;
    }

    // PreListElement
    public RuleCall getPreListElementParserRuleCall_2_3_2() {
      return cPreListElementParserRuleCall_2_3_2;
    }

    // startCommand+=EString
    public Assignment getStartCommandAssignment_2_3_3() {
      return cStartCommandAssignment_2_3_3;
    }

    // EString
    public RuleCall getStartCommandEStringParserRuleCall_2_3_3_0() {
      return cStartCommandEStringParserRuleCall_2_3_3_0;
    }
    ...
    // PreListElement
    public RuleCall getPreListElementParserRuleCall_2_3_4_0() {
      return cPreListElementParserRuleCall_2_3_4_0;
    }

    // startCommand+=EString
    public Assignment getStartCommandAssignment_2_3_4_1() {
      return cStartCommandAssignment_2_3_4_1;
    }

    // EString
    public RuleCall getStartCommandEStringParserRuleCall_2_3_4_1_0() {
      return cStartCommandEStringParserRuleCall_2_3_4_1_0;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_2_3_5() {
      return cDEDENTTerminalRuleCall_2_3_5;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_2_4() {
      return cDEDENTTerminalRuleCall_2_4;
    }
  }
  public class AbstractComputationAssignmentElements extends AbstractParserRuleElementFinder {
    ...
    private final RuleCall cRossystemImplementationAssignmentParserRuleCall =
        (RuleCall) rule.eContents().get(1);
    ...
    // RossystemImplementationAssignment
    public RuleCall getRossystemImplementationAssignmentParserRuleCall() {
      return cRossystemImplementationAssignmentParserRuleCall;
    }
  }
  public class RossystemImplementationAssignmentElements extends AbstractParserRuleElementFinder {
    private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(),
        "de.fraunhofer.ipa.deployment.PlanWithRosmodel.RossystemImplementationAssignment");
    private final Group cGroup = (Group) rule.eContents().get(1);
    ...
    private final CrossReference cExecutedByComputationDeviceInstanceCrossReference_5_0 =
        (CrossReference) cExecutedByAssignment_5.eContents().get(0);
    private final RuleCall cExecutedByComputationDeviceInstanceEStringParserRuleCall_5_0_1 =
        (RuleCall) cExecutedByComputationDeviceInstanceCrossReference_5_0.eContents().get(1);
    ...
    private final RuleCall cVersionEStringParserRuleCall_7_0 =
        (RuleCall) cVersionAssignment_7.eContents().get(0);
    private final Keyword cMiddlewareKeyword_8 = (Keyword) cGroup.eContents().get(8);
    private final Assignment cMiddlewareAssignment_9 = (Assignment) cGroup.eContents().get(9);
    private final RuleCall cMiddlewareMiddlewareParserRuleCall_9_0 =
        (RuleCall) cMiddlewareAssignment_9.eContents().get(0);
    private final Keyword cSoftwareComponentsKeyword_10 = (Keyword) cGroup.eContents().get(10);
    private final RuleCall cINDENTTerminalRuleCall_11 = (RuleCall) cGroup.eContents().get(11);
    private final RuleCall cPreListElementParserRuleCall_12 = (RuleCall) cGroup.eContents().get(12);
    private final Assignment cSoftwareComponentsAssignment_13 =
        (Assignment) cGroup.eContents().get(13);
    private final RuleCall cSoftwareComponentsConfigRosSoftwareComponentParserRuleCall_13_0 =
        (RuleCall) cSoftwareComponentsAssignment_13.eContents().get(0);
    private final Group cGroup_14 = (Group) cGroup.eContents().get(14);
    private final RuleCall cPreListElementParserRuleCall_14_0 =
        (RuleCall) cGroup_14.eContents().get(0);
    private final Assignment cSoftwareComponentsAssignment_14_1 =
        (Assignment) cGroup_14.eContents().get(1);
    private final RuleCall cSoftwareComponentsConfigRosSoftwareComponentParserRuleCall_14_1_0 =
        (RuleCall) cSoftwareComponentsAssignment_14_1.eContents().get(0);
    private final RuleCall cDEDENTTerminalRuleCall_15 = (RuleCall) cGroup.eContents().get(15);
    private final Group cGroup_16 = (Group) cGroup.eContents().get(16);
    private final Keyword cRuntimeTypeKeyword_16_0 = (Keyword) cGroup_16.eContents().get(0);
    private final Assignment cRuntimeTypeAssignment_16_1 =
        (Assignment) cGroup_16.eContents().get(1);
    private final RuleCall cRuntimeTypeAbstractRuntimeParserRuleCall_16_1_0 =
        (RuleCall) cRuntimeTypeAssignment_16_1.eContents().get(0);
    ...
    public RuleCall getPreListElementParserRuleCall_0() {
      return cPreListElementParserRuleCall_0;
    }

    //'name:'
    public Keyword getNameKeyword_1() {
      return cNameKeyword_1;
    }
    ...
    public RuleCall getNameEStringParserRuleCall_2_0() {
      return cNameEStringParserRuleCall_2_0;
    }

    // INDENT
    public RuleCall getINDENTTerminalRuleCall_3() {
      return cINDENTTerminalRuleCall_3;
    }

    //'executedBy:'
    public Keyword getExecutedByKeyword_4() {
      return cExecutedByKeyword_4;
    }

    // executedBy=[targetEnvironment::ComputationDeviceInstance|EString]
    public Assignment getExecutedByAssignment_5() {
      return cExecutedByAssignment_5;
    }

    //[targetEnvironment::ComputationDeviceInstance|EString]
    public CrossReference getExecutedByComputationDeviceInstanceCrossReference_5_0() {
      return cExecutedByComputationDeviceInstanceCrossReference_5_0;
    }

    // EString
    public RuleCall getExecutedByComputationDeviceInstanceEStringParserRuleCall_5_0_1() {
      return cExecutedByComputationDeviceInstanceEStringParserRuleCall_5_0_1;
    }

    //'version:'
    public Keyword getVersionKeyword_6() {
      return cVersionKeyword_6;
    }

    // version = EString
    public Assignment getVersionAssignment_7() {
      return cVersionAssignment_7;
    }

    // EString
    public RuleCall getVersionEStringParserRuleCall_7_0() {
      return cVersionEStringParserRuleCall_7_0;
    }

    //'middleware:'
    public Keyword getMiddlewareKeyword_8() {
      return cMiddlewareKeyword_8;
    }

    // middleware=Middleware
    public Assignment getMiddlewareAssignment_9() {
      return cMiddlewareAssignment_9;
    }

    // Middleware
    public RuleCall getMiddlewareMiddlewareParserRuleCall_9_0() {
      return cMiddlewareMiddlewareParserRuleCall_9_0;
    }

    //'softwareComponents:'
    public Keyword getSoftwareComponentsKeyword_10() {
      return cSoftwareComponentsKeyword_10;
    }

    // INDENT
    public RuleCall getINDENTTerminalRuleCall_11() {
      return cINDENTTerminalRuleCall_11;
    }

    // PreListElement
    public RuleCall getPreListElementParserRuleCall_12() {
      return cPreListElementParserRuleCall_12;
    }

    // softwareComponents+= ConfigRosSoftwareComponent
    public Assignment getSoftwareComponentsAssignment_13() {
      return cSoftwareComponentsAssignment_13;
    }

    // ConfigRosSoftwareComponent
    public RuleCall getSoftwareComponentsConfigRosSoftwareComponentParserRuleCall_13_0() {
      return cSoftwareComponentsConfigRosSoftwareComponentParserRuleCall_13_0;
    }
    ...
    // PreListElement
    public RuleCall getPreListElementParserRuleCall_14_0() {
      return cPreListElementParserRuleCall_14_0;
    }

    // softwareComponents+=ConfigRosSoftwareComponent
    public Assignment getSoftwareComponentsAssignment_14_1() {
      return cSoftwareComponentsAssignment_14_1;
    }

    // ConfigRosSoftwareComponent
    public RuleCall getSoftwareComponentsConfigRosSoftwareComponentParserRuleCall_14_1_0() {
      return cSoftwareComponentsConfigRosSoftwareComponentParserRuleCall_14_1_0;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_15() {
      return cDEDENTTerminalRuleCall_15;
    }
    ...
    //'runtimeType:'
    public Keyword getRuntimeTypeKeyword_16_0() {
      return cRuntimeTypeKeyword_16_0;
    }

    // runtimeType=AbstractRuntime
    public Assignment getRuntimeTypeAssignment_16_1() {
      return cRuntimeTypeAssignment_16_1;
    }

    // AbstractRuntime
    public RuleCall getRuntimeTypeAbstractRuntimeParserRuleCall_16_1_0() {
      return cRuntimeTypeAbstractRuntimeParserRuleCall_16_1_0;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_17() {
      return cDEDENTTerminalRuleCall_17;
    }
  }
  public class ConfigRosParameterElements extends AbstractParserRuleElementFinder {
    private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(
        getGrammar(), "de.fraunhofer.ipa.deployment.PlanWithRosmodel.ConfigRosParameter");
    private final Group cGroup = (Group) rule.eContents().get(1);
    private final Action cConfigRosParameterAction_0 = (Action) cGroup.eContents().get(0);
    private final RuleCall cPreListElementParserRuleCall_1 = (RuleCall) cGroup.eContents().get(1);
    private final Group cGroup_2 = (Group) cGroup.eContents().get(2);
    private final Keyword cRefSysParamKeyword_2_0 = (Keyword) cGroup_2.eContents().get(0);
    private final Assignment cRefSysParamAssignment_2_1 = (Assignment) cGroup_2.eContents().get(1);
    private final CrossReference cRefSysParamParameterCrossReference_2_1_0 =
        (CrossReference) cRefSysParamAssignment_2_1.eContents().get(0);
    private final RuleCall cRefSysParamParameterEStringParserRuleCall_2_1_0_1 =
        (RuleCall) cRefSysParamParameterCrossReference_2_1_0.eContents().get(1);
    private final Group cGroup_3 = (Group) cGroup.eContents().get(3);
    private final Keyword cRefNodeParamKeyword_3_0 = (Keyword) cGroup_3.eContents().get(0);
    private final Assignment cRefNodeParamAssignment_3_1 = (Assignment) cGroup_3.eContents().get(1);
    private final CrossReference cRefNodeParamRosParameterCrossReference_3_1_0 =
        (CrossReference) cRefNodeParamAssignment_3_1.eContents().get(0);
    private final RuleCall cRefNodeParamRosParameterEStringParserRuleCall_3_1_0_1 =
        (RuleCall) cRefNodeParamRosParameterCrossReference_3_1_0.eContents().get(1);
    private final Group cGroup_4 = (Group) cGroup.eContents().get(4);
    private final RuleCall cINDENTTerminalRuleCall_4_0 = (RuleCall) cGroup_4.eContents().get(0);
    private final Group cGroup_4_1 = (Group) cGroup_4.eContents().get(1);
    private final Keyword cToKeyword_4_1_0 = (Keyword) cGroup_4_1.eContents().get(0);
    private final Assignment cToAssignment_4_1_1 = (Assignment) cGroup_4_1.eContents().get(1);
    private final CrossReference cToAbstractConfigPropertyCrossReference_4_1_1_0 =
        (CrossReference) cToAssignment_4_1_1.eContents().get(0);
    private final RuleCall cToAbstractConfigPropertyEStringParserRuleCall_4_1_1_0_1 =
        (RuleCall) cToAbstractConfigPropertyCrossReference_4_1_1_0.eContents().get(1);
    private final Group cGroup_4_2 = (Group) cGroup_4.eContents().get(2);
    private final Keyword cValueKeyword_4_2_0 = (Keyword) cGroup_4_2.eContents().get(0);
    private final Assignment cValueAssignment_4_2_1 = (Assignment) cGroup_4_2.eContents().get(1);
    private final RuleCall cValuePropertyValueParserRuleCall_4_2_1_0 =
        (RuleCall) cValueAssignment_4_2_1.eContents().get(0);
    ...
    //{ConfigRosParameter}
    public Action getConfigRosParameterAction_0() {
      return cConfigRosParameterAction_0;
    }

    // PreListElement
    public RuleCall getPreListElementParserRuleCall_1() {
      return cPreListElementParserRuleCall_1;
    }

    //('refSysParam:' refSysParam=[ros::Parameter|EString])?
    public Group getGroup_2() {
      return cGroup_2;
    }

    //'refSysParam:'
    public Keyword getRefSysParamKeyword_2_0() {
      return cRefSysParamKeyword_2_0;
    }

    // refSysParam=[ros::Parameter|EString]
    public Assignment getRefSysParamAssignment_2_1() {
      return cRefSysParamAssignment_2_1;
    }

    //[ros::Parameter|EString]
    public CrossReference getRefSysParamParameterCrossReference_2_1_0() {
      return cRefSysParamParameterCrossReference_2_1_0;
    }

    // EString
    public RuleCall getRefSysParamParameterEStringParserRuleCall_2_1_0_1() {
      return cRefSysParamParameterEStringParserRuleCall_2_1_0_1;
    }
    ...
    //'refNodeParam:'
    public Keyword getRefNodeParamKeyword_3_0() {
      return cRefNodeParamKeyword_3_0;
    }

    // refNodeParam=[rossystem::RosParameter|EString]
    public Assignment getRefNodeParamAssignment_3_1() {
      return cRefNodeParamAssignment_3_1;
    }

    //[rossystem::RosParameter|EString]
    public CrossReference getRefNodeParamRosParameterCrossReference_3_1_0() {
      return cRefNodeParamRosParameterCrossReference_3_1_0;
    }

    // EString
    public RuleCall getRefNodeParamRosParameterEStringParserRuleCall_3_1_0_1() {
      return cRefNodeParamRosParameterEStringParserRuleCall_3_1_0_1;
    }
    ...
    // INDENT
    public RuleCall getINDENTTerminalRuleCall_4_0() {
      return cINDENTTerminalRuleCall_4_0;
    }
    ...
    //'to:'
    public Keyword getToKeyword_4_1_0() {
      return cToKeyword_4_1_0;
    }

    // to=[targetEnvironment::AbstractConfigProperty|EString]
    public Assignment getToAssignment_4_1_1() {
      return cToAssignment_4_1_1;
    }

    //[targetEnvironment::AbstractConfigProperty|EString]
    public CrossReference getToAbstractConfigPropertyCrossReference_4_1_1_0() {
      return cToAbstractConfigPropertyCrossReference_4_1_1_0;
    }

    // EString
    public RuleCall getToAbstractConfigPropertyEStringParserRuleCall_4_1_1_0_1() {
      return cToAbstractConfigPropertyEStringParserRuleCall_4_1_1_0_1;
    }
    ...
    //'value:'
    public Keyword getValueKeyword_4_2_0() {
      return cValueKeyword_4_2_0;
    }

    // value= PropertyValue
    public Assignment getValueAssignment_4_2_1() {
      return cValueAssignment_4_2_1;
    }

    // PropertyValue
    public RuleCall getValuePropertyValueParserRuleCall_4_2_1_0() {
      return cValuePropertyValueParserRuleCall_4_2_1_0;
    }

    // DEDENT
    public RuleCall getDEDENTTerminalRuleCall_4_3() {
      return cDEDENTTerminalRuleCall_4_3;
    }
  }
  ...
  @Inject
  public PlanWithRosmodelGrammarAccess(GrammarProvider grammarProvider, PlanGrammarAccess gaPlan,
      UtilGrammarAccess gaUtil, TerminalsGrammarAccess gaTerminals) {
  ...
  public PlanGrammarAccess.AbstractConfigExecutionParameterElements
  getAbstractConfigExecutionParameterAccess() {
  ...
  //;
  public UtilGrammarAccess.AbstractComputationAssignmentTargetElements
  getAbstractComputationAssignmentTargetAccess() {
  ...
  //;
  public UtilGrammarAccess.AbstractOperatingSystemPropertyElements
  getAbstractOperatingSystemPropertyAccess() {
  ...
  //    DEDENT
  //    ;
  public UtilGrammarAccess.NameOperatingSystemPropertyElements
  getNameOperatingSystemPropertyAccess() {
  ...
  //    DEDENT
  //    ;
  public UtilGrammarAccess.VersionOperatingSystemPropertyElements
  getVersionOperatingSystemPropertyAccess() {
  ...
  //;
  public UtilGrammarAccess.ProcessorArchitectureValueElements
  getProcessorArchitectureValueAccess() {
  ...
  // terminal DOUBLE returns ecore::EDouble: (DIGIT* | ('-' DIGIT*) ) (('.' DECINT*) | (('.'
  // DIGIT*)? ('E'|'e') ('-'|'+')? DIGIT*));

...
public class PlanWithRosmodelSemanticSequencer extends PlanSemanticSequencer {
    ...
    if (epackage == DeployPlanWithRosModelPackage.eINSTANCE)
      switch (semanticObject.eClass().getClassifierID()) {
        ...
        case DeployPlanWithRosModelPackage.ROSSYSTEM_IMPLEMENTATION_ASSIGNMENT:
          sequence_RossystemImplementationAssignment(
              context, (RossystemImplementationAssignment) semanticObject);
          return;
      }
      ...
      switch (semanticObject.eClass().getClassifierID()) {
        case UtilPackage.ABSTRACT_COMPUTATION_ASSIGNMENT_TARGET:
          sequence_AbstractComputationAssignmentTarget(
              context, (AbstractComputationAssignmentTarget) semanticObject);
          return;
        ...
        case UtilPackage.NAME_OPERATING_SYSTEM_PROPERTY:
          sequence_NameOperatingSystemProperty(
              context, (NameOperatingSystemProperty) semanticObject);
          return;
        ...
        case UtilPackage.VERSION_OPERATING_SYSTEM_PROPERTY:
          sequence_VersionOperatingSystemProperty(
              context, (VersionOperatingSystemProperty) semanticObject);
          return;
   ...
   *
   * Constraint:
   *     (refSysParam=[Parameter|EString]? refNodeParam=[RosParameter|EString]?
   * to=[AbstractConfigProperty|EString]? value=PropertyValue?)
   * </pre>
   */
  protected void sequence_ConfigRosParameter(
      ISerializationContext context, ConfigRosParameter semanticObject) {
   ...
   *
   * Constraint:
   *     (component=[Component|EString] executionConfiguration+=ConfigRosParameter*
   * (startCommand+=EString startCommand+=EString*)?)
   * </pre>
   */
  protected void sequence_ConfigRosSoftwareComponent(
      ISerializationContext context, ConfigRosSoftwareComponent semanticObject) {
    genericSequencer.createSequence(context, semanticObject);
  }
   ...
   *
   * Constraint:
   *     (name=EString targetRossystem=[System|EString]? deployTo=[TargetDeployEnviroment|EString]
   * realize=AbstractRealization)
   * </pre>
   */
  protected void sequence_DeploymentPlanWithRosModel(
      ISerializationContext context, DeployRossystemPlan semanticObject) {
    genericSequencer.createSequence(context, semanticObject);
  }
   ...
   * </pre>
   */
  protected void sequence_RossystemImplementationAssignment(
      ISerializationContext context, RossystemImplementationAssignment semanticObject) {
    genericSequencer.createSequence(context, semanticObject);
  }
}

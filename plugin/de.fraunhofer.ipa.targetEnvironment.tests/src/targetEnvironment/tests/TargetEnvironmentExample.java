...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>targetEnvironment</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetEnvironmentExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TargetEnvironmentPackage.eNS_URI, 

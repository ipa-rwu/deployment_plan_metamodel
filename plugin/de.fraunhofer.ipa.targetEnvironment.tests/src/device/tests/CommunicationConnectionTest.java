...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Communication Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class CommunicationConnectionTest extends AbstractCommunicationConnectionTest {
	...
	public static void main(String[] args) {
		TestRunner.run(CommunicationConnectionTest.class);
	}

	/**
	 * Constructs a new Communication Connection test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public CommunicationConnectionTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		setFixture(DeviceFactory.eINSTANCE.createCommunicationConnection());
	}
	...
	/**
	 * Tests the '{@link device.CommunicationConnection#getType() <em>Type</em>}' feature getter.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

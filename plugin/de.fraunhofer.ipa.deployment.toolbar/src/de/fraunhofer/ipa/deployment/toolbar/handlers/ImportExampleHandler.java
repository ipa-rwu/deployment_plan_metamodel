...
public class ImportExampleHandler extends AbstractHandler {
  ...
  private LibraryImporter libraryImporter = new LibraryImporter();
   private static final Map<String, String> LIBRARY_MAP = new HashMap<>();
     static {
         LIBRARY_MAP.put("ROSDeploymentExample", "https://github.com/ipa-rwu/ROSDeploymentExample.git");
     }
  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    MessageDialog.openInformation(
        ...
        try {
            ...
            e.printStackTrace();
            MessageDialog.openError(window.getShell(), "Import Error", "Failed to import the example: " + e.getMessage());
        }

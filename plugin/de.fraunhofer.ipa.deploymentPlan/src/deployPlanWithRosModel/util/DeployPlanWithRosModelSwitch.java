...
public class DeployPlanWithRosModelSwitch<T> extends Switch<T> {
   ...
   */
    ...
    switch (classifierID) {
      ...
      case DeployPlanWithRosModelPackage.DEPLOY_ROSSYSTEM_PLAN: {
        DeployRossystemPlan deployRossystemPlan = (DeployRossystemPlan)theEObject;
        T result = caseDeployRossystemPlan(deployRossystemPlan);
        if (result == null) result = caseAbstractDeploymentPlan(deployRossystemPlan);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   */
    ...
    /**
   * Returns the result of interpreting the object as an instance of '<em>Deploy Rossystem Plan</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Deploy Rossystem Plan</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDeployRossystemPlan(DeployRossystemPlan object) {
    return null;
  }

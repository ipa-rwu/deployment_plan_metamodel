...
public class ImplementationDescriptionGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
    ...
    public class RepositoryElements extends AbstractParserRuleElementFinder {
        private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fraunhofer.ipa.deplyoment.ImplementationDescription.Repository");
        private final Group cGroup = (Group)rule.eContents().get(1);
    ...
    public class RepositoryTypeElements extends AbstractParserRuleElementFinder {
        private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fraunhofer.ipa.deplyoment.ImplementationDescription.RepositoryType");
    ...
    public class GitRepositoryTypeElements extends AbstractParserRuleElementFinder {
        private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fraunhofer.ipa.deplyoment.ImplementationDescription.GitRepositoryType");
        private final Group cGroup = (Group)rule.eContents().get(1);

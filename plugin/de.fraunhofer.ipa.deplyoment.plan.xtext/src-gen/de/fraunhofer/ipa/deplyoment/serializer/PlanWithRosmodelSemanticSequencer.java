...
public class PlanWithRosmodelSemanticSequencer extends PlanSemanticSequencer {
    ...
    public void sequence(ISerializationContext context, EObject semanticObject) {
        ...
        if (epackage == DeployPlanWithRosModelPackage.eINSTANCE)
            ...
            case DeployPlanWithRosModelPackage.ROSSYSTEM_ASSIGNMENT:
                sequence_RossystemAssignment(context, (RossystemAssignment) semanticObject);
                return;
            }
     ...
     *     AbstractDeploymentPlan returns DeploymentPlanWithRosModel
     *
     * Constraint:
     ...
     * <pre>
     * Contexts:
     *     AbstractComputationAssignment returns RossystemAssignment
     *     RossystemAssignment returns RossystemAssignment
     *
     * Constraint:
     *     (executedBy=[ComputationDeviceInstance|EString] softwareComponent+=ConfigRosSoftwareComponent softwareComponent+=ConfigRosSoftwareComponent*)
     * </pre>
     */
    protected void sequence_RossystemAssignment(ISerializationContext context, RossystemAssignment semanticObject) {
        genericSequencer.createSequence(context, semanticObject);
    }

...
public class ConnectedDeviceImpl extends MinimalEObjectImpl.Container implements ConnectedDevice {
   ...
   * @ordered
   */
    protected AbstractDeviceInstance refDevice;
   ...
   * @ordered
   */
    protected AbstractCommunicationConnection refConnection;
   ...
   * @generated
   */
    public AbstractDeviceInstance getRefDevice() {
    if (refDevice != null && refDevice.eIsProxy()) {
      InternalEObject oldRefDevice = (InternalEObject)refDevice;
      refDevice = (AbstractDeviceInstance)eResolveProxy(oldRefDevice);
   ...
   * @generated
   */
    public AbstractDeviceInstance basicGetRefDevice() {
    return refDevice;
  }
   ...
   * @generated
   */
    public void setRefDevice(AbstractDeviceInstance newRefDevice) {
    AbstractDeviceInstance oldRefDevice = refDevice;
   ...
   * @generated
   */
    public AbstractCommunicationConnection getRefConnection() {
    if (refConnection != null && refConnection.eIsProxy()) {
      InternalEObject oldRefConnection = (InternalEObject)refConnection;
      refConnection = (AbstractCommunicationConnection)eResolveProxy(oldRefConnection);
   ...
   * @generated
   */
    public AbstractCommunicationConnection basicGetRefConnection() {
    return refConnection;
  }
   ...
   * @generated
   */
    public void setRefConnection(AbstractCommunicationConnection newRefConnection) {
    AbstractCommunicationConnection oldRefConnection = refConnection;
   ...
   */
    ...
    switch (featureID) {
      case TargetEnvironmentPackage.CONNECTED_DEVICE__REF_DEVICE:
        setRefDevice((AbstractDeviceInstance)newValue);
        return;
      case TargetEnvironmentPackage.CONNECTED_DEVICE__REF_CONNECTION:
        setRefConnection((AbstractCommunicationConnection)newValue);
        return;
      case TargetEnvironmentPackage.CONNECTED_DEVICE__PROPERTIES:
        getProperties().clear();
   ...
   */
    ...
    switch (featureID) {
      case TargetEnvironmentPackage.CONNECTED_DEVICE__REF_DEVICE:
        setRefDevice((AbstractDeviceInstance)null);
        return;
      case TargetEnvironmentPackage.CONNECTED_DEVICE__REF_CONNECTION:
        setRefConnection((AbstractCommunicationConnection)null);
        return;
      case TargetEnvironmentPackage.CONNECTED_DEVICE__PROPERTIES:
        getProperties().clear();
        return;

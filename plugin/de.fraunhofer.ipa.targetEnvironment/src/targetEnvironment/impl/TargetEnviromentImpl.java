...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Target Enviroment</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link targetEnvironment.impl.TargetEnviromentImpl#getName <em>Name</em>}</li>
 *   <li>{@link targetEnvironment.impl.TargetEnviromentImpl#getIncludeDevice <em>Include Device</em>}</li>
 *   <li>{@link targetEnvironment.impl.TargetEnviromentImpl#getConfigConnection <em>Config Connection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetEnviromentImpl extends MinimalEObjectImpl.Container implements TargetEnviroment {
	/**
	 ...
	 * @generated
	 */
	protected TargetEnviromentImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TargetEnvironmentPackage.Literals.TARGET_ENVIROMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TargetEnvironmentPackage.TARGET_ENVIROMENT__NAME, oldName, name));
	}
	...
	public EList<DeviceInstance> getIncludeDevice() {
		if (includeDevice == null) {
			includeDevice = new EObjectContainmentEList<DeviceInstance>(DeviceInstance.class, this, TargetEnvironmentPackage.TARGET_ENVIROMENT__INCLUDE_DEVICE);
		}
	...
	public EList<ConfigConnection> getConfigConnection() {
		if (configConnection == null) {
			configConnection = new EObjectContainmentEList<ConfigConnection>(ConfigConnection.class, this, TargetEnvironmentPackage.TARGET_ENVIROMENT__CONFIG_CONNECTION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TargetEnvironmentPackage.TARGET_ENVIROMENT__INCLUDE_DEVICE:
				return ((InternalEList<?>)getIncludeDevice()).basicRemove(otherEnd, msgs);
			case TargetEnvironmentPackage.TARGET_ENVIROMENT__CONFIG_CONNECTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TargetEnvironmentPackage.TARGET_ENVIROMENT__NAME:
				return getName();
			case TargetEnvironmentPackage.TARGET_ENVIROMENT__INCLUDE_DEVICE:

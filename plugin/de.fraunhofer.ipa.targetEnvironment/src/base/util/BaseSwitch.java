...
public class BaseSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case BasePackage.PROPERTY_VALUE: {
            ...
            case BasePackage.PROPERTY_VALUE_INT: {
                ...
                if (result == null) result = casePropertyValue(propertyValueInt);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case BasePackage.PROPERTY_VALUE_DOUBLE: {
                ...
                if (result == null) result = casePropertyValue(propertyValueDouble);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case BasePackage.PROPERTY_VALUE_STRING: {
                ...
                if (result == null) result = casePropertyValue(propertyValueString);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }

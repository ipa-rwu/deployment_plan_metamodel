 ...
 * </p>
 * <ul>
 *   <li>{@link device.impl.PropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link device.impl.PropertyImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
    ...
    protected EClass eStaticClass() {
        return DevicePackage.Literals.PROPERTY;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DevicePackage.PROPERTY__NAME, oldName, name));
    }
